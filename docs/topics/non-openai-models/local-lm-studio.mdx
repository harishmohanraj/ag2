...
## Two Agent Chats
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ag2ai/ag2/blob/main/website/docs/topics/non-openai-models/local-lm-studio.ipynb)
<a href="https://github.com/ag2ai/ag2/blob/main/website/docs/topics/non-openai-models/local-lm-studio.ipynb" target="_blank"><img noZoom src="https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github" alt="Open on GitHub" /></a>
