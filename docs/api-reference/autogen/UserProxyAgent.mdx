...
| `**kwargs` | Please refer to other kwargs in [ConversableAgent](../ConversableAgent#conversableagent).<br/><br/>**Type:** Any |
...
| Name | Description |
|--|--|
| `message` | message to be sent.<br/><br/>The message could contain the following fields: - content (str or List): Required, the content of the message.<br/><br/>(Can be None) - function_call (str): the name of the function to be called.<br/><br/>- name (str): the name of the function to be called.<br/><br/>- role (str): the role of the message, any role that is not "function" will be modified to "assistant".<br/><br/>- context (dict): the context of the message, which will be passed to [OpenAIWrapper.create](https://harishmohanraj.github.io/ag2/latest/docs/api-reference/autogen/OpenAIWrapper/#create).<br/><br/>For example, one agent can send a message A as:<br/><br/>**Type:** dict[str, typing.Any] \| str |
