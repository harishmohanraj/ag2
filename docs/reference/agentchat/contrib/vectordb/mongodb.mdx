...
MongoDBAtlasVectorDB(
    ...
    embedding_function: Callable = &lt;bound method SentenceTransformer.encode of SentenceTransformer(
...
| `embedding_function` | Callable | The embedding function used to generate the vector representation.<br/><br/>**Type:** `Callable`<br/><br/>**Default:** &lt;bound method SentenceTransformer.encode of SentenceTransformer(
  (0) |
...
create_index_if_not_exists(
    self,
    index_name: str = 'vector_index',
    collection: pymongo.synchronous.collection.Collection = None
) -> None
```
...
| `collection` | The MongoDB collection to create the index on.<br/><br/>Defaults to None.<br/><br/>**Type:** `pymongo.synchronous.collection.Collection`<br/><br/>**Default:** None |
...
| Name | Description |
|--|--|
| `collection` | An existing Collection in the Atlas Database.<br/><br/>**Type:** `pymongo.synchronous.collection.Collection` |
