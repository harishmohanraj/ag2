...
| Name | Description |
|--|--|
| `conn` | psycopg.Connection | A customer connection object to connect to the database.<br/><br/>A connection object may include additional key/values: https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNSTRING<br/><br/>**Type:** `psycopg.Connection \| None`<br/><br/>**Default:** None |
...
| Name | Description |
|--|--|
| `conn` | An existing psycopg connection object.<br/><br/>If provided, this connection will be used.<br/><br/>**Type:** `psycopg.Connection \| None`<br/><br/>**Default:** None |
