...
create_qdrant_from_dir(
    dir_path: str,
    max_tokens: int = 4000,
    client: qdrant_client.qdrant_client.QdrantClient = None,
    ...
    parallel: int = 0,
    on_disk: bool = False,
    quantization_config: qdrant_client.http.models.models.ScalarQuantization | qdrant_client.http.models.models.ProductQuantization | qdrant_client.http.models.models.BinaryQuantization | None = None,
    hnsw_config: qdrant_client.http.models.models.HnswConfigDiff | None = None,
...
| `client` | the QdrantClient instance.<br/><br/>Default is None.<br/><br/>**Type:** `qdrant_client.qdrant_client.QdrantClient`<br/><br/>**Default:** None |
...
| `quantization_config` | Quantization configuration.<br/><br/>If None, quantization will be disabled.<br/><br/>Ref: https://qdrant.github.io/qdrant/redoc/index.html#tag/collections/operation/create_collection<br/><br/>**Type:** `qdrant_client.http.models.models.ScalarQuantization \| qdrant_client.http.models.models.ProductQuantization \| qdrant_client.http.models.models.BinaryQuantization \| None`<br/><br/>**Default:** None |
| `hnsw_config` | HNSW configuration.<br/><br/>If None, default configuration will be used.<br/><br/>Ref: https://qdrant.github.io/qdrant/redoc/index.html#tag/collections/operation/create_collection<br/><br/>**Type:** `qdrant_client.http.models.models.HnswConfigDiff \| None`<br/><br/>**Default:** None |
...
query_qdrant(
    ...
    embedding_model: str = 'BAAI/bge-small-en-v1.5',
    qdrant_client_options: dict | None = \{}
) -> list[list[qdrant_client.fastembed_common.QueryResponse]]
```
...
| `client` | the QdrantClient instance.<br/><br/>A default in-memory client will be instantiated if None.<br/><br/>**Type:** `qdrant_client.qdrant_client.QdrantClient`<br/><br/>**Default:** None |
| `collection_name` | the name of the collection.<br/><br/>Default is "all-my-documents".<br/><br/>**Type:** `str`<br/><br/>**Default:** 'all-my-documents' |
...
| Type | Description |
|--|--|
| `list[list[qdrant_client.fastembed_common.QueryResponse]]` | List[List[QueryResponse]]: the query result. The format is: class QueryResponse(BaseModel, extra="forbid"): # type: ignore id: Union[str, int] embedding: Optional[List[float]] metadata: Dict[str, Any] document: str score: float |
