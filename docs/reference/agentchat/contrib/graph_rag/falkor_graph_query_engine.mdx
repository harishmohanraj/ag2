...
| `model` | LLM model to use for FalkorDB to build and retrieve from the graph, default to use OAI gpt-4o.<br/><br/>**Type:** `ForwardRef('GenerativeModel') \| None`<br/><br/>**Default:** None |
| `ontology` | FalkorDB knowledge graph schema/ontology, https://github.com/FalkorDB/GraphRAG-SDK/blob/main/graphrag_sdk/ontology.py If None, FalkorDB will auto generate an ontology from the input docs.<br/><br/>**Type:** `ForwardRef('Ontology') \| None`<br/><br/>**Default:** None |
