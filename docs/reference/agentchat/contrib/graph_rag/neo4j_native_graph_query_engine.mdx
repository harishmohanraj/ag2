...
Neo4jNativeGraphQueryEngine(
    ...
    embeddings: neo4j_graphrag.embeddings.base.Embedder | None = &lt;neo4j_graphrag.embeddings.openai.OpenAIEmbeddings object>,
    embedding_dimension: int | None = 3072,
    llm: neo4j_graphrag.llm.base.LLMInterface | None = &lt;neo4j_graphrag.llm.openai_llm.OpenAILLM object>,
    query_llm: neo4j_graphrag.llm.base.LLMInterface | None = &lt;neo4j_graphrag.llm.openai_llm.OpenAILLM object>,
...
| `embeddings` | Embedding model to embed chunk data and retrieve answers.<br/><br/>**Type:** `neo4j_graphrag.embeddings.base.Embedder \| None`<br/><br/>**Default:** &lt;neo4j_graphrag.embeddings.openai.OpenAIEmbeddings object> |
| `embedding_dimension` | Dimension of the embeddings for the model.<br/><br/>**Type:** `int \| None`<br/><br/>**Default:** 3072 |
| `llm` | Language model for creating the knowledge graph (returns JSON responses).<br/><br/>**Type:** `neo4j_graphrag.llm.base.LLMInterface \| None`<br/><br/>**Default:** &lt;neo4j_graphrag.llm.openai_llm.OpenAILLM object> |
| `query_llm` | Language model for querying the knowledge graph.<br/><br/>**Type:** `neo4j_graphrag.llm.base.LLMInterface \| None`<br/><br/>**Default:** &lt;neo4j_graphrag.llm.openai_llm.OpenAILLM object> |
