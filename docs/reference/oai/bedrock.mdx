...
```python
create(self, params) -> openai.types.chat.chat_completion.ChatCompletion
```
...
```python
parse_params(self, params: dict[str, Any]) -> tuple[dict[str, typing.Any], dict[str, typing.Any]]
```
