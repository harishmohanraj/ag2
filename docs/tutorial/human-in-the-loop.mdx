...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ag2ai/ag2/blob/main/website/docs/tutorial/human-in-the-loop.ipynb)
[![Open on GitHub](https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github)](https://github.com/ag2ai/ag2/blob/main/website/docs/tutorial/human-in-the-loop.ipynb)
...
## Human Input Mode = `NEVER` {#human-input-mode-never}
...
## Human Input Mode = `ALWAYS` {#human-input-mode-always}
...
## Human Input Mode = `TERMINATE` {#human-input-mode-terminate}
